package com.arthur.helpdesk.resources;
...
import com.arthur.helpdesk.services.ChamadoService;
...
public class ChamadoResource {
	...
	@GetMapping(value = "/{id}") // AQUI AO INVEZ DE BUSCAR POR ID SERIA POR DATE
