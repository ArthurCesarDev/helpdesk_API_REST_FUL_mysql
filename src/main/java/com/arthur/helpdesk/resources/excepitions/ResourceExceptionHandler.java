package com.arthur.helpdesk.resources.excepitions;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandarError> validationErrors(MethodArgumentNotValidException ex, HttpServletRequest request) {
		...
		ValidationError errors = new ValidationError(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(), "Validation error", "Error na validação dos campos"
